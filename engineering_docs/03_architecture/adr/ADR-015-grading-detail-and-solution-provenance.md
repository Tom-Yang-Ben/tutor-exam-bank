...
> **編號說明:** `docs/interfaces-stage5.md` 第 6 條只分配了 ADR-010～013，沒有 WS-A 的編號；本檔取下一個未用的 014，整合階段可重編。〔修訂 2026-09-24〕整合時與補救卷的 ADR-014 撞號，本檔改號為 ADR-015（裁決 S5-1，主控提交 `bbea5e6`）。
