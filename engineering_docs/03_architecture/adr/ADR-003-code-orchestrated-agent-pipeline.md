...
> 🛠 **2026-09-16b 修訂**（主線同步，PR #30–#33 合併後）：§3 理由 1 單元測試數同步為 1,613（PR #30–#33 併入 main 後 CI 實測）。修改處以〔修訂 2026-09-16b〕行內標記。
...
1. prompt 不構成保證，伺服器端驗證才是：每道閘門為一般程式碼，行為由 1,613 項單元測試固定（PR #30–#33 併入 main 後 CI 實測，2026-09-16）。〔修訂 2026-09-16b〕
