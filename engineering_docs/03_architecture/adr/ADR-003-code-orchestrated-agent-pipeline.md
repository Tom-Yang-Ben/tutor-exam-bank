...
> 🛠 **2026-09-15 修訂**（測試數同步）：§3 理由 1 單元測試數 1,445→1,449（main 126243a 實測，2026-09-15）。修改處以〔修訂 2026-09-15〕行內標記。
> 🛠 **2026-09-15d 修訂**（測試數同步）：§3 理由 1 單元測試數 1,449→1,476（main f2af3c2 實測，2026-09-15 晚間）。修改處以〔修訂 2026-09-15d〕行內標記。
> 🛠 **2026-09-15f 修訂**（測試數同步）：§3 理由 1 單元測試數 1,476→1,507（feat/follow-up-links 實跑）。修改處以〔修訂 2026-09-15f〕行內標記。
...
1. prompt 不構成保證，伺服器端驗證才是：每道閘門為一般程式碼，行為由 1,507 項單元測試固定（feat/follow-up-links 實測，2026-09-15）。〔修訂 2026-09-15f〕
