...
- 下游：DEC-001～012 → FR-001～019／NFR-001～006（[engineering_tracker](../03_architecture/engineering_tracker.md)）〔修訂 2026-09-15e〕；DEC-013 → FR-020〔修訂 2026-09-15f〕；Gate 證據 → TC 與 eval（[qa_tracker](../05_qa/qa_tracker.md)）；重大取捨 → ADR-001～009（[adr/](../03_architecture/adr/)）〔修訂 2026-09-15f〕。
