...
> **實例:** 單例
> **定位:** 本文件回答「系統提供哪些功能（FR-001～019〔修訂 2026-09-15e〕）、各功能以何種可觀察行為驗收（ACPT）、AI 不確定性的邊界場景（SCN）」；需求決策沿革歸 [`requirements_tracker.md`](./requirements_tracker.md)，技術實作與 ADR 歸 `../03_architecture/`。〔修訂 2026-08-29〕
...
| | | ACPT-019-5 | When 組卷抽到承上題或其前題，Then 整組一起出現且順序正確（待 PR2） |
| | | ACPT-019-6 | When 刪除或封存被承接的前題，Then 系統擋下或提示整組處理，不留下缺前情的承上題（硬刪已擋下並回 409 列出承上題〔修訂 2026-09-15f〕；封存與整組處理待 PR3） |
...
| 項目 | 內容 |
| :--- | :--- |
| **功能範圍** | 拆題管線（FR-001～006）／題庫與出卷（FR-007～009）／RAG 三落點與 NLQ（FR-010～013）／產品收斂與助教（FR-014～016）／上線後增量：來源標記與附圖（FR-017～018）〔修訂 2026-08-29〕、承上題綁定（FR-019）〔修訂 2026-09-15e〕 |
...
| 項目 | ID |
| :--- | :--- |
| 上游 | DEC-001～DEC-012（[`requirements_tracker.md`](./requirements_tracker.md) ①需求決策）〔修訂 2026-09-15e〕 |
| 本文件產出 | FR-001～FR-019、ACPT-001-1～ACPT-019-6、SCN-011～SCN-016〔修訂 2026-09-15e〕 |
