...
> **實例:** 單例
> **定位:** 本文件回答「系統提供哪些功能（FR-001～020〔修訂 2026-09-15e〕〔修訂 2026-09-15f〕）、各功能以何種可觀察行為驗收（ACPT）、AI 不確定性的邊界場景（SCN）」；需求決策沿革歸 [`requirements_tracker.md`](./requirements_tracker.md)，技術實作與 ADR 歸 `../03_architecture/`。〔修訂 2026-08-29〕
...
| 項目 | 內容 |
| :--- | :--- |
| **功能範圍** | 拆題管線（FR-001～006）／題庫與出卷（FR-007～009）／RAG 三落點與 NLQ（FR-010～013）／產品收斂與助教（FR-014～016）／上線後增量：來源標記與附圖（FR-017～018）〔修訂 2026-08-29〕、承上題綁定（FR-019）〔修訂 2026-09-15e〕、拆題結果對照原卷文字層（FR-020）〔修訂 2026-09-15f〕 |
...
| 項目 | ID |
| :--- | :--- |
| 上游 | DEC-001～DEC-012（[`requirements_tracker.md`](./requirements_tracker.md) ①需求決策）〔修訂 2026-09-15e〕、DEC-013〔修訂 2026-09-15f〕 |
| 本文件產出 | FR-001～FR-019、ACPT-001-1～ACPT-019-7〔修訂 2026-09-15g〕、SCN-011～SCN-016〔修訂 2026-09-15e〕；FR-020、ACPT-020-1～ACPT-020-3〔修訂 2026-09-15f〕 |
