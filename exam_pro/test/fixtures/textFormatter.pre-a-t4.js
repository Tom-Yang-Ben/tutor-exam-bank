// test/fixtures/textFormatter.pre-a-t4.js —— A-T4 動工前的 utils/textFormatter.js 逐字副本（凍結，永不編輯）
//
// 用途：test/unit/textFormatterStrict.test.js 的「逐位元對照測試」——
// 證明 A-T4 埋事件之後，buildParagraphComponents / parseLatexToMath 的輸出與動工前完全相同。
// 對照基準取自 commit e1740ca（S0 介面凍結）時的 utils/textFormatter.js。
